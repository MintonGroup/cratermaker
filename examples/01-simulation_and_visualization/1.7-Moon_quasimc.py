...
production_diameter             The `D` value (in meters) used in the N(D) convention
                                (e.g. 1e3 would be used to indicate N(1), 20e3 for N(20), etc.)
production_number_low           The low end of a range of N(D) values, given in units of craters
                                per 1 million sq. km.
production_number_high          The high end of a range of N(2) values,  given in units of craters
                                per 1 million sq. km.
production_number               Equivalent to setting the production_number_high and
                                production_number_low to the same value.
production_time_low             The low end of a range of time values (in My before present)
production_time_high            The high end of a range of time values (in My before present)
production_time                 Equivalent to setting production_time_low and production_time_high to be the same.
