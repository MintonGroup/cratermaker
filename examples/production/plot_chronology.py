...
ax.plot(age_vals*1e-3, N1_moon*1e6, '-', color='dimgrey', linewidth=2.0, zorder=50, label="Moon")
ax.plot(age_vals*1e-3, N1_mars*1e6, '-', color='orange', linewidth=2.0, zorder=50, label="Mars")
