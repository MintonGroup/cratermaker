...
class Crater:
    ...
    def __post_init__(self):
        ...
        object.__setattr__(self, 'final_diameter', fd)
        object.__setattr__(self, 'final_radius', fr)
        object.__setattr__(self, 'transient_diameter', td)
        object.__setattr__(self, 'transient_radius', tr)
        object.__setattr__(self, 'projectile_diameter', pd)
        object.__setattr__(self, 'projectile_radius', pr)
        object.__setattr__(self, 'projectile_mass', pm)
        object.__setattr__(self, 'projectile_density', prho)
        object.__setattr__(self, 'morphology_type', mt)
        object.__setattr__(self, 'projectile_mean_velocity', pmv)
        object.__setattr__(self, 'projectile_velocity', pv)
        object.__setattr__(self, 'projectile_vertical_velocity', pvv)
        object.__setattr__(self, 'projectile_angle', pang)
        object.__setattr__(self, 'projectile_direction', pdir)
