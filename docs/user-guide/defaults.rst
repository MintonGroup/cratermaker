...
- **Counting**:Currently one counting model available: ``depthcount``. This is a model that is similar to that used by CTEM. It is based on a depth-to-diameter cutoff value determined by Minton et al. (2019) [#]_ with corrections for complex craters given by Riedel et al. (2020) [#]_
