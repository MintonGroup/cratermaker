...
+======================+===================+=======================================================================+
| |NPF|                | "neukum"          | production = Production.maker("neukum",version="projectile")          |
+----------------------+-------------------+-----------------------------------------------------------------------+
| |PowerLawProduction| | "powerlaw"        | production = Production.maker("powerlaw", slope=-4.0, N1_coef=1.0e-6) |
+----------------------+-------------------+-----------------------------------------------------------------------+
