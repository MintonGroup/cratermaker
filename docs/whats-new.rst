...
- Improvements to core structure and documentation. :pull:`89` `David Minton`_

   - Added grid files generated by the examples to the repository as lfs objects. This will make the examples generate far more quickly, as they can use cached versions of the grids instead of generating them from scratch when building the documentation in a clean system, such as on Readthedocs.
