...
class TestCrater(unittest.TestCase):
    ...
    def test_invalid_combinations(self):
        with self.assertRaises(ValueError):
            Crater.maker(projectile_diameter=1000, projectile_radius=500, projectile_velocity=20e3)
        with self.assertRaises(ValueError):
    ...
    def test_invalid_target_or_rng_type(self):
        with self.assertRaises(ValueError):
            Crater.maker(projectile_diameter=1000, target="invalid_target", projectile_mean_velocity=10e3)
